...
def calculate_surplus_data(sales_row):
    ...
    stock_row = stock[-1]
    """
    To access the last item in a list when the lenght of the list varies:
...
def main():
    """
    Common practice to wrap main function calls of a programme within a function called main.
